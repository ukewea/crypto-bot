...
class Crypto:
    ...
    def get_tradable_symbols(self, quoteAsset):
        ...
        return [[symbol['symbol'], symbol['baseAsset']] for symbol in trade_with_usdt if symbol['status'].upper() == "TRADING" and "MARKET" in symbol['orderTypes'] and not "LEVERAGED" in symbol['permissions']]
